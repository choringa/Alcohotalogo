...
public abstract class ManejadorConexion {
    ...
    /**
     * Ubicación del servicio a consumir
     */
    private String nombreServicio;

    /**
     * Comando para realizar la conexión http desde BalckBerry
     */
     ...
     * @param nConexion comando de conexión http
     */
    ...
    /**
     * Consume un servicio y devuelve la información entregada por este para objetos deifinidos por java es decir no byte[]
     * @param servicio el servicio que se desea consumir
     * @param nombreParams el nombre de los parámetros solicitados por el servicio
     * @param params los parámetros solicitados por el servicio
...
//            SoapPrimitive resultsRequestSOAP = (SoapPrimitive)envelope.getResponse();
    ...
    /**
     * Consume un servicio y devuelve la información entregada por este para el caso de manejar la respuesta si es un objeto x es decir en byte[]
     * @param servicio el servicio que se desea consumir
     * @param nombreParams el nombre de los parámetros solicitados por el servicio
     * @param params los par�metros solicitados por el servicio
     * @return la respuesta entregada por el servicio
     * @throws Exception en caso de que no se pueda realizar la conexión
     */
